...
public class FooterLinks {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		WebElement footer= driver.findElement(By.xpath("//aside[@class='main-sidebar']"));  // Get Footer element which contains all footer links
		...
		for(int j = 0;j<i;j++){    //create loop based upon number of links to traverse all links
			footer= driver.findElement(By.xpath("//aside[@class='main-sidebar']"));   // We are re-creating "footer" webelement as DOM changes after navigate.back()
			...
			footer.findElements(By.tagName("a")).get(j).sendKeys(selectLinkOpeninNewTab);
			Thread.sleep(3000);
